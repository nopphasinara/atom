...
define(function(require, exports, module) {
    ...
    for (var i = 0; i < node._attributes.length; i++) {
      node._attributes[i].name = node._attributes[i].name.toLowerCase();

      if (node._attributes[i].name == 'id' || node._attributes[i].name == 'class') {
        if (isAttributeExists == '') {
          isAttributeExists = node._attributes[i].name;
        }
      }
    }
