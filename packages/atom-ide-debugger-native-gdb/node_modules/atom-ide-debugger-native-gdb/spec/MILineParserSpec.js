...
function _load_MILineParser() {return _MILineParser = _interopRequireDefault(require('../lib/MILineParser'));}var _MIRecord;
...
describe('MILineParser', () => {
  ...
  beforeEach(() => {
    parser = new (_MILineParser || _load_MILineParser()).default();
  });
  ...
  describe('when given the debugger prompt', () => {
    it('should return an empty record', () => {
      ...
      expect(record.constructor).toBe((_MIRecord || _load_MIRecord()).MIRecord.prototype.constructor);
    });
  });
  ...
  describe('when given stream output events', () => {
    it('should parse console output properly', () => {
      ...
      expect(record instanceof (_MIRecord || _load_MIRecord()).MIStreamRecord).toBe(true);if (!(
      record instanceof (_MIRecord || _load_MIRecord()).MIStreamRecord)) {throw new Error('Invariant violation: "record instanceof MIStreamRecord"');}
  ...
  describe('when given result output', () => {
    it('should parse empty output properly', () => {
      ...
      expect(record instanceof (_MIRecord || _load_MIRecord()).MIResultRecord).toBe(true);
  ...
  describe('when given async output', () => {
    it('should parse empty async exec output properly', () => {
      ...
      expect(record instanceof (_MIRecord || _load_MIRecord()).MIAsyncRecord).toBe(true);
