...
class KeyboardShortcuts {
  constructor(diagnosticUpdater) {
    ...
    this._subscriptions.add((0, _event().observableFromSubscribeFunction)(diagnosticUpdater.observeMessages).subscribe(diagnostics => {
      this._index = null;
  ...
  gotoCurrentIndex() {
    ...
    if (range == null) {
      (0, _goToLocation().goToLocation)(diagnostic.filePath);
    } else {
      (0, _goToLocation().goToLocation)(diagnostic.filePath, {
  ...
  trySetCurrentTrace(traces, traceIndex) {
    ...
    if (trace.filePath != null && trace.range != null) {
      ...
      (0, _goToLocation().goToLocation)(trace.filePath, {
