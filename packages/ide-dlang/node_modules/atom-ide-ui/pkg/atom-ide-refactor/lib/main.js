...
class Activation {
  constructor() {
    ...
    this._disposables = new (_UniversalDisposable().default)((0, _refactorUIs().initRefactorUIs)(this._store), atom.commands.add('atom-workspace', 'nuclide-refactorizer:refactorize', () => {
