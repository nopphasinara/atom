...
var _require = require('graphql-compiler'),
...
var relayQueryTransforms = [require('./RelayApplyFragmentArgumentTransform').transform, SkipClientFieldTransform.transform, SkipUnreachableNodeTransform.transform, require('./RelayGenerateIDFieldTransform').transform];
